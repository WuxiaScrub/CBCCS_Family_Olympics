...
// The CDN script declares a top-level `supabase` global for the library
// itself, so reassign that same global to the client instance rather than
// redeclaring it with const/let (which throws "already declared").
