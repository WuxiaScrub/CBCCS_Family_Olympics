-- Run this once against an existing Supabase project to add the overall
-- ranking view used by the admin dashboard. Safe to run more than once
-- (it's just a view, no table changes).
